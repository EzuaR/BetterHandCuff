...
<div style="background-color: #fff3cd; color: #856404; border: 1px solid #ffeeba; padding: 15px; border-radius: 5px; margin-bottom: 20px;">
  ...
  The current configuration is poorly prepared, so I recommend creating your own custom configuration instead of using the default one.
</div>
**Debug** doesn't work for now.
